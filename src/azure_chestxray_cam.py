...
#     print(crt_xray_image.shape)
    ...
    crt_predictions, crt_cam_image, predicted_disease_index =get_score_and_cam_picture(crt_xray_image, DenseNetImageNet121_model)
    ...
    for crt_image in nih_data_files:
        ...
        crt_xray_image = cv2.resize(crt_xray_image, 
                                    (prj_consts.CHESTXRAY_MODEL_EXPECTED_IMAGE_HEIGHT, 
                                     prj_consts.CHESTXRAY_MODEL_EXPECTED_IMAGE_WIDTH)).astype(np.float32)
